...
export const SystemGeneral: React.FC = () => {
  ...
  const {operation: fetchEpcLicenseData, data: epcLicenseData} = useHttp<SystemGeneralEcpLicenseInformation[]>({url: '/api/v1/system/general/epc-license', method: 'GET'});
  const {operation: fetchSoftwareVersionData, data: softwareVersionData} = useHttp<SystemGeneralSoftwareVersionInformation[]>({url: '/api/v1/system/general/software-version', method: 'GET'});
