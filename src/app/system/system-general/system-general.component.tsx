...
export const SystemGeneral: React.FC = () => {
  ...
  const {operation: fetchEpcLicenseData, data: epcLicenseData} = useHttp<SystemGeneralEcpLicenseInformation[]>({url: '/api/system/general/epc-license', method: 'GET'});
  const {operation: fetchSoftwareVersionData, data: softwareVersionData} = useHttp<SystemGeneralSoftwareVersionInformation[]>({url: '/api/system/general/software-version', method: 'GET'});
